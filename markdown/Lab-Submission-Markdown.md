...
After that, we calculate the variance of TOTALS, which helps us
...
categorical values.This is the absenteesim percentage to the Totals
column.
...
\`\`\`{r Calculate Correlation} \# Select only numeric columns for
